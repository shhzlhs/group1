...
import PaymentMenthods from "./AddCoinPage/PaymentMenthods";
import { Link } from "react-router-dom";
import ChooseMoney from "./AddCoinPage/ChooseMoney";
import PaymentInfo from "./AddCoinPage/PaymentInfo";
function AddCoinPage(props) {
